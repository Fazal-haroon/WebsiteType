    ...
    <div class="container_12">
        ...
        <div class="grid_10">
            <div class="box round first">
              ...
              $logo_q = mysql_query("select * from logo where logo_id = '$eidd' ");
				$logo_r = mysql_fetch_array($logo_q);
                 ...
                 <form action="" method="post">
                    <table class="form">
                      ...
                      <td>
                       ...
                       <input type="text" name="logo" value="<?php echo $logo_r["logo_name"]; ?>" />
                       
                       <input type="submit" name="submit" value="update logo" />
                            </td>
                           ...
                           <?php
                            if(isset($_POST['submit']))
							{
								...
								mysql_query("update logo set logo_name = '$n_logo'");

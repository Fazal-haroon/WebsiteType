...
<body>
    <div class="container_12">
                    ...
                    <ul class="section menu">
                        <li><a class="menuitem">students</a>
                            <ul class="empty">
                                ...
                                <li><a href="add_campus.php">Add_campus</a> </li>
        ...
        <div class="grid_10">
                ...
                <div class="block">
                 <form action="" method="post">
                    <table class="form">
                      ...
                      <tr><td><label>your campus</label></td>
                         <td>  
                          <input type="text" name="campus"  /></td>
                         
                      </tr>
                      
                      <tr>
                         <td><input type="submit" name="submit" value="Add campus"  /></td>
                      </tr>
                    ...
                    if(isset($_POST["submit"]))
					{
						...
						mysql_query("insert into add_campus(campus) value('$campus')");
         ...
         <?php
                $q = mysql_query("select * from add_campus");
